...
CORS(app, origins=["https://projeto-lev.vercel.app", "http://localhost:5173", "http://localhost:3000", "http://localhost:3001", "http://192.168.1.90:30001"], expose_headers=["Content-Disposition"])
